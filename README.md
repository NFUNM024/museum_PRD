...
API|需求|核心功能|重要性
---|:--:|:--:|--:
语音识别|通过语音查找想要参观的展品位置与信息|将60s以内的语音精准识别为文字|重要
语音合成|通过语音合成将用户所查找的展品的位置与信息通过语音反馈给用户|提供高度拟人，流畅自然的语音合成服务|重要
人流量统计|通过统计各展馆人数，智能推荐用户参观展馆|统计人体个数和人流趋势，以头肩为主要识别目标统计人数|次重要
图片搜索|通过上传展品的照片来获得展品的信息|在自建图库中搜索相同及相似的商品图片集|次重要
